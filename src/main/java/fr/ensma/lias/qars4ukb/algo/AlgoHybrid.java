...
public class AlgoHybrid extends AbstractAlgo {
	 ...
	 * 
	 * @param a list of queries
	 * @param b list of queries
	 ...
	 * 
	 * @param initial  list of queries
	 * @param toRemove collection to remove from the initial
	 ...
	 * @param properSubQueries proper sub queries of the initial query
	 ...
	 * 
	 * @param initial list of queries
	 * @param atomicQ list of atomic queries
	 * @return the initial list of queries with out including queries witch contains
	 *         atomic one
	 */
	 ...
	 * threshold (Algorithm DiscoverMFSXSS of the publication)
	 * 
	 * @param initialQuery  the query on which the algorithm is executed
	 * @param discoveredXSS the previous set of XSSs
	 * @param alpha         the threshold
	 * @param session       the connection to the KB
	 */
	 ...
	 * 
	 * @param left  position of the minimum threshold
	 * @param right position of the maximum threshold
	 * @param res   the ordered list
	 * @param tab   the initial list of threshold
	 */
