...
public abstract class AbstractQuery implements Query {
	...
	/**
	 * Most queries will be created during the execution of LBA the newInitialQuery
	 * represents the query on which LBA was executed
	 */
	 ...
	 * 
	 * @param query the initial query on which LBA was executed
	 */
	 ...
	 * 
	 * @param factory a factory to create some queries
	 * @param tps     the triple patterns of the query
	 */
	...
	/**
	 * Computes the string of this query when a some triple patterns have changed
	 */
	 ...
	 * query
	 * 
	 * @param queryToConcat query that must be concatened
	...
	/**
	 * The opt query uses bitmap so we define a method to avoid using bitmap when
	 * needed.
	 * 
	 * @param q a query
	 ...
	 * @return the position the positions of the triple patterns of this query in
	 *         the initial query
	 */
	 ...
	 * 
	 * @param initialQuery the initial failing query
	 * @return a string representing the query in the simple form: ti ^ ... ^ tj
	 *         w.r.t the initial query
	 */
