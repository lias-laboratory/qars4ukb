 ...
 */
public class VirtuosoExperimentAlgoTest {

    Logger log = Logger.getLogger(VirtuosoExperimentAlgoTest.class);
   ...
   // @Test
	...
	final URL fileUrl = VirtuosoExperimentAlgoTest.class.getResource(filename);
