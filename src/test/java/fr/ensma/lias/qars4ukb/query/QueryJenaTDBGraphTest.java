 ...
 */
public class QueryJenaTDBGraphTest {
	...
	factory = new JenaTDBGraphQueryFactory();
	factoryOpt = new JenaTDBGraphQueryOptFactory();
	session = ((JenaTDBGraphQueryOptFactory) factoryOpt).createSession(dataset);
    }
